...
operation::create-event[snippets='request-fields,curl-request,http-request, request-headers, http-response,response-headers,response-fields,http-response,links']
...
operation::get-event[snippets='request-fields,curl-request,http-response,response-fields,links']
